...
- current_state_age: 19.1 hours old
...
- run_index_rows_source: 325
- handoff_index_rows_source: 208
- report_index_rows_source: 253
...
- `ARIADNE_C8_REDACTED_SAMPLE_POLICY_DECISION` | status=`UNKNOWN` | latest=`2026-05-28T04:38:18.741882+00:00`
...
- `ARIADNE_AUDIT_AGENTS_SKILLS_INSTALL_POINTER_PLAN` | status=`UNKNOWN` | latest=`2026-05-28T04:34:10.763359+00:00`
- `ARIADNE_CONTEXT_REFRESH_AND_RUNTIME_HOOK_CANDIDATE_V1_12_20260528` | status=`PASS_WITH_DEGRADED_FEATURES` | latest=`2026-05-28T04:34:03.036587+00:00`
- `ARIADNE_CHROMA_HEALTHCHECK_PATCH_APPROVAL_REQUIRED` | status=`UNKNOWN` | latest=`2026-05-28T04:30:31.324398+00:00`
- `ARIADNE_DUCKDB_SCHEDULED_RUN_OBSERVATION` | status=`UNKNOWN` | latest=`2026-05-28T04:26:01.904423+00:00`
- `ATLAS_P2_GDRIVE_PUBLISHER` | status=`PASS` | latest=`2026-05-28T04:25:03.428117+00:00`
- `WINDOW_ATLAS_V3B_WARNING_REPAIR` | status=`PASS` | latest=`2026-05-28T04:19:47.205076+00:00`
- `interactive_0267be6f` | status=`UNKNOWN` | latest=`2026-05-28T04:17:53.555316+00:00`
